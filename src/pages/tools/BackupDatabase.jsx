        ...
        <>
            <div className="w-full h-full text-center">
                <div className="h-full flex flex-column justify-content-center align-items-center">
                    ...
                    <h2 className="text-gray-500 mb-1 mt-0 text-5xl font-bold">Database Backups</h2>
                    <p className="text-xl py-0 my-0 text-600">{translate("MSG.BACKUP_YOUR_DATABASE")}</p>
